// Run SQL directly against Supabase using the pg connection
// Usage: node scripts/run-sql.js
...
const req = https.request(url, options, (res) => {
  ...
  res.on('end', () => {
    if (res.statusCode >= 200 && res.statusCode < 300) {
      ...
      console.log('Go to: https://supabase.com/dashboard/project/gxtbvsdclblkngycdmkz/sql');
      console.log('Paste the SQL from database/migration-company-context.sql');
    }
  });
});
